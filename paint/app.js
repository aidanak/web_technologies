...
var mode,originalEvent,dataTransfer,files,select=false,erase=false,paint=false,c,ls;
...
var run = function(){
  $('.col-sm-10').on('dragleave', function(e){
...
function stroke(mouseX, mouseY) {
        if(mode=="pencil"){
          ...
          ctx.arc(previousMouseX,previousMouseY,ls.value,0,Math.PI*2,false);
          ctx.fill();
          move(mouseX, mouseY);
        }
        else if(mode=="select"){
...
ls = document.getElementById("range");
...
$(document).ready(function(){
  ...
  $('#upload').click(function(){
    loadCanvas(document.getElementById("url").value);
  });
